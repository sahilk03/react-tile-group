...
var FuseCard = function (_React$Component) {
    _inherits(FuseCard, _React$Component);

    function FuseCard() {
        _classCallCheck(this, FuseCard);

        return _possibleConstructorReturn(this, (FuseCard.__proto__ || Object.getPrototypeOf(FuseCard)).apply(this, arguments));
    }

    _createClass(FuseCard, [{
        key: 'render',
